...
#SBATCH -J "rs-4"   # job name

## /SBATCH -p general # partition (queue)
#SBATCH -o rs-4-slurm.%N.%j.out # STDOUT
#SBATCH -e rs-4-slurm.%N.%j.err # STDERR
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:298402190365:awsnotify --message "RS-4-Done"
