...
#SBATCH -J "rs-1"   # job name

## /SBATCH -p general # partition (queue)
#SBATCH -o rs-1-slurm.%N.%j.out # STDOUT
#SBATCH -e rs-1-slurm.%N.%j.err # STDERR
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:298402190365:awsnotify --message "RS-1-Done"
