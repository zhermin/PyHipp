...
#SBATCH -J "rs-3"   # job name

## /SBATCH -p general # partition (queue)
#SBATCH -o rs-3-slurm.%N.%j.out # STDOUT
#SBATCH -e rs-3-slurm.%N.%j.err # STDERR
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:298402190365:awsnotify --message "RS-3-Done"
